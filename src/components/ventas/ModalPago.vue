<template>
  <div class="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
    <div class="bg-white rounded-lg shadow-lg p-6 min-w-[350px] dark:bg-gray-800">
      ...
      <div v-if="pago >= props.total" class="mb-3 text-green-600 font-bold">
...
// Enfocamos el input automaticamente al abrir el modal
onMounted(() => {
...
function confirmarVenta() {
  ...
  emits('confirmar', {
    ...
    // total_final es el total ya con descuentos por producto aplicados
    // que viene calculado desde el computed del padre
