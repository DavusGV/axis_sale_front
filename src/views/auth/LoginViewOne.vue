...
<template>
  ...
  >
      ...
      <div class="box w-full p-3 md:p-4 xl:p-6 items-center">
        <form class="box bg-primary/5 dark:bg-bg3 lg:p-6 xl:p-8">
          ...
          <div class="bg-n0 dark:bg-bg4 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3 mb-4 relative">
            <input :type="showPass ? 'text' : 'password'" class="w-11/12 text-sm focus:outline-none bg-transparent" placeholder="Enter Your Password" id="password" required />
    ...
    <div class="col-span-2 lg:col-span-1 flex items-center justify-center">
      <img src="/images/login-1.png" class="relative z-[2] px-4" alt="img" :width="696" :height="547" />
    </div>
  </div>
</template>
